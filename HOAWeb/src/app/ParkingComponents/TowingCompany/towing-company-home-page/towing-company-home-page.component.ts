...
@Component({
  selector: 'app-towing-company-home-page',
  templateUrl: './towing-company-home-page.component.html',
  styleUrls: ['./towing-company-home-page.component.css']
})
export class TowingCompanyHomePageComponent {
  userdata:any;
 ...
 ngOnInit(): void {
  this.GetAllTowingCompanyAssignments();
  }
...
GetAllTowingCompanyAssignments() {
 


    this.parkingService.GetAllTowingCompanyAssignments(this.userdata.UserName).then(
      (response) => {
